...
# В моем понимании кажд.5сек(по моим параметрам) должны запускаться функции парсинга
...
# Но в основной документации Celery настройки прописаны к проект Джанго
# А это опять же время и не факт что заработает
